...
export const metadata: Metadata = {
  title: 'Sàn giao dịch',
  description:
    'Tổng hợp các sàn giao dịch và chương trình IB mà Gemi Trader đang đồng hành, kèm lưu ý minh bạch về rủi ro.',
}
...
const brokerReviews: BrokerReviews[] = [
  {
    brokerName: 'Exness',
    brokerLogo: 'X',
    reviews: [
...
export default function Brokers() {
  return (
    <>
      <PageIntro eyebrow="Sàn giao dịch" title="Review & Hướng dẫn các sàn giao dịch uy tín">
        <p>
          Tổng hợp các bài đánh giá, hướng dẫn đăng ký và sử dụng các sàn giao dịch mà Gemi Trader
          đang đồng hành. Mỗi sàn có nhiều bài viết chi tiết giúp bạn dễ dàng lựa chọn và bắt đầu.
        </p>
      </PageIntro>

      <Container className="mt-12 sm:mt-16 lg:mt-20">
        <FadeInStagger className="space-y-20">
          {brokerReviews.map((broker, index) => (
                ...
                <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-5">
                    <div className="relative">
                      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-teal-500 via-teal-600 to-teal-700 text-2xl font-bold text-white shadow-xl shadow-teal-500/30 transition-transform duration-300 hover:scale-105">
                        {broker.brokerLogo}
                      </div>
        ...
        <FadeIn>
          <p className="mt-12 max-w-3xl text-sm text-neutral-500 dark:text-neutral-400">
            *Rủi ro: Giao dịch trên thị trường tài chính luôn tiềm ẩn khả năng mất vốn. Hãy chỉ sử
            dụng số tiền bạn chấp nhận rủi ro, đọc kỹ điều khoản của sàn và chủ động tìm hiểu trước
            khi ra quyết định.
          </p>
        </FadeIn>
      </Container>
